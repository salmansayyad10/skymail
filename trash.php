<h2 style="background-color:#09F; text-align:center; font-size:20px; height:25px; margin-bottom:0px; margin-top:-3px; opacity:0.8">Trash</h2><?php


$u=$_SESSION['user'];
	
$x1=mysqli_connect("localhost","root","","trash");
...
$sc=opendir("User_Data/$u/trash/$too/$code");
...
{	
    ...
    echo "<img src='User_Data/$u/trash/$too/$code/$img' width='80' height='50px'/>  ";
   echo"</td>";
